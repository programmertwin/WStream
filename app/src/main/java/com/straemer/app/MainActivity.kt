...
class MainActivity : ComponentActivity() {
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    btnStart.setOnClickListener { startService(Intent(this, HttpForegroundService::class.java)) }
    btnShow.setOnClickListener { tv.text = UiDumpAccessibilityService.lastXml.get() }
  }
}
